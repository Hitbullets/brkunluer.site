...
const expertise = [
  ...
  { icon: Workflow, title: 'Prompt Mühendisliği ve AI İş Akışları', desc: 'Doğru soruları, araçları ve üretim adımlarını bir araya getiren etkili iş akışları tasarlamak.' },
...
export default function AboutPage() {
  return (
    <section className='relative overflow-hidden bg-atmosphere-studio ambient-spotlight bg-noise border-b border-white/5'>
      <Container className='py-16 sm:py-20 lg:py-24'>
        ...
        <section className='mt-24 max-w-3xl'>
          ...
          <div className='space-y-6 text-body-lg leading-relaxed text-muted-foreground'>
            ...
            <p>
              Burada proje geliştirme süreçlerimi, üretken yapay zekâ alanındaki keşiflerimi, kullandığım araçları ve çalışma yöntemlerini bulabilirsiniz.
            </p>
            <p>
              Amacım yalnızca ürün geliştirmek değil; öğrendiklerimi açık ve anlaşılır biçimde paylaşarak başkalarının da daha hızlı üretmesine katkı sağlamak. Teknoloji, yapay zekâ ve ürün geliştirme üzerine konuşmayı seviyorsanız doğru yerdesiniz.
            </p>
          </div>
        </section>
        ...
        <section className='mt-24'>
          ...
          <div className='grid md:grid-cols-2 gap-6 max-w-3xl'>
            <Card variant='feature'>
              ...
              <CardContent>
                <p className='text-muted-foreground mb-4'>Proje teklifleri, sorular veya iş birliği için:</p>
            ...
            <Card variant='feature'>
              ...
              <CardContent>
                <p className='text-muted-foreground mb-4'>Kısa bir sohbet için 30 dakikalık bir zaman ayırın:</p>
